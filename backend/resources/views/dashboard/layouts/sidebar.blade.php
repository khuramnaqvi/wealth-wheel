<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" @yield('dashboard') "><a href="{{url('/admin')}}"><i class="feather icon-home"></i><span
                        class="menu-title" data-i18n="Dashboard">Dashboard</span></a>
            </li>

            <li class=" @yield('user') "><a href="{{url('/admin/users')}}"><i class="fa fa-user-circle"></i><span
                        class="menu-title" data-i18n="Dashboard">users</span></a>
            </li>

{{--            <li class=" @yield('currency') "><a href="{{url('/admin/currency')}}"><i class="fa fa-dollar"></i><span--}}
{{--                        class="menu-title" data-i18n="Dashboard">Currencies</span></a>--}}
{{--            </li>--}}
