                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body card-dashboard">
                                    ...
                                    <form action="{{route('update',['user'=>$user->id])}}" id="validationForm" method="post">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" required value="{{$user->email}}" class="form-control" name="email"  placeholder="email">
                                        </div>
