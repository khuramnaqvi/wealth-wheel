      ...
      @if (session('error'))
        ...
        <form method="POST" action="">
            ...
            <div class="form-group">
              ...
              <input id="email" name="email" value="" type="email" class="form-control @error('email') is-invalid @enderror"  aria-describedby="log-userName" placeholder="Enter name" required>
