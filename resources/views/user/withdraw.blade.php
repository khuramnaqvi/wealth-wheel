        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content" style="border-radius: 45px; margin-top: 123px;">
                <div class="site_colr" style=" border-radius: 42px 42px 0px 0px;">
                    <h5 class="modal-title" id="staticBackdropLabel"style="text-align: center;padding-top: 15px;padding-bottom: 15px;">Withdraw</h5>
                            ...
                            <div class="col-6"  style="text-align: center; margin-bottom:10px;">
                                <form action="{{url('wihdraw_submit')}}" method="post">
                                    ...
                                    <div class="form-group" style="text-align: left;">
                                        ...
                                        <input required min="1" max="{{auth()->user()->balance}}" type="number" name="withdraw" placeholder="Enter Amount To Withdraw" class=" form-control checkamount2" onkeyup="this.value=this.value.replace(/[^0-9]/g)" style="border-radius: 30px;">
                                    </div>
