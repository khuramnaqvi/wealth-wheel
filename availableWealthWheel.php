...
<head>
  ...
  <title>available wealth wheel - Wealth Wheel</title>
    ...
    <div id="heroCarousel" data-bs-interval="5000" class="container carousel carousel-fade" data-bs-ride="">
      ...
      <div class="carousel-item active">
        <div class="carousel-container">
          <h2 class="animate__animated animate__fadeInDown">Available Wealth Wheel</h2>
    ...
    <section id="terms" class="faq ww-terams">
      <div class="container">
        ...
        <div class="section-title" data-aos="zoom-out">
          <h2>Available Wealth Wheel</h2>
          <p>Here is the availability of wealth wheel</p>
        </div>
