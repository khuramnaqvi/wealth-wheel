...
(function (factory) {
    ...
    var Checkboxes = function (settings) {
        ...
        this.s = {dt: new DataTable.Api(settings), columns: [], data: [], dataDisabled: [], ignoreSelect: false};
        ...
        _constructor: function () {
                ...
                if (ctx.aoColumns[i].checkboxes) {
                    ...
                    if (ctx.aoColumns[i].mRender === null) {
                        colOptions["render"] = function () {
                            return '<input type="checkbox" name="count_check[]" class="dt-checkboxes count_check" value="">';
                        };
                    }
            ...
            if (hasCheckboxes) {
                ...
                if (hasCheckboxesSelectRow) {
                    ...
                    $table.on("students-select.dt.dtCheckboxes", function (e, dt, type, cell, originalEvent) {
            ...
            if (ctx.aoColumns[colIdx].checkboxes && ctx.aoColumns[colIdx].checkboxes.selectAll) {
                ...
                if (isChanged || isSelectedNow !== isSelected || isIndeterminateNow !== isIndeterminate) {
                    ...
                    $checkboxesSelectAll.prop({"checked": isSelected, "indeterminate": isIndeterminate});
            ...
            if (colIdx !== null) {
                ...
                var add = function ($el, name, num) {
                    $el.append($('<span class="select-item"/>').append(dt.i18n("select." + name + "s", {
                        _: "%d " + name + "s selected",
                        0: "",
                        1: "1 " + name + " selected"
                    }, num)));
